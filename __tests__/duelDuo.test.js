...
describe("Duel Duo tests", () => {
  ...
  test("clicking the Draw button displays the div with id = “choices”", async () => {
    await driver.get("http://localhost:8000");
    await driver.wait(until.elementLocated(By.css("#draw")),1000).click()

    let choicesDiv = await driver.wait(until.elementLocated(By.css("#choices")),1000)
  ...
  test("clicking an “Add to Duo” button displays the div with id = “player-duo”", async () => {
    ...
    await driver.wait(until.elementLocated(By.css(".bot-btn")),1000).click()
